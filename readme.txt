...
Stable tag: 1.0.1
License: MIT
License URI: https://github.com/otacke/sustainum-h5p-local-user-data/blob/master/LICENSE
...
2. Pick the latest release (or the one that you want to use) and download the
   `sustainum-h5p-local-user-data.zip` file.
...
== Configure ==
The "Sustainum H5P Local User Data" plugin for WordPress does not need to be configured. In order to become active,
...
3. Set "Auto-save frequency (in seconds)" to the time interval that should be used. The "Sustainum H5P Local User Data"
...
demands to enter personal information. The "Sustainum H5P Local User Data" plugin does not allow you to get hold
